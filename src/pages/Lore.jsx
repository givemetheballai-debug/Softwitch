    ...
    <div className="max-w-6xl mx-auto px-6 py-12 space-y-12">
      ...
      >
        ...
        <p className="text-lg text-midnight-aubergine/80 leading-relaxed">
          A soft, modern encyclopedia of the frameworks behind SoftWitch.
        </p>
        <p className="text-midnight-aubergine/70">
          Nothing heavy. Nothing mystical. Just gentle patterns, emotional tools, and tiny bits of cosmic wisdom.
        </p>
        <p className="text-midnight-aubergine/70">
          Welcome to the Cosmic Lore Library — the place where all the soft cosmic background lives.
        </p>
        <p className="text-midnight-aubergine/70 italic">
          Nothing here is definitive or overwhelming; it's a light, modern exploration of rituals, cycles, and meaning-making.
        </p>
      </motion.div>

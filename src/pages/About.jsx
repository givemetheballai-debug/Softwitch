        ...
        >
          ...
          >
            ...
            <div className="snapshot-content space-y-4">
              <p className="snapshot-date">Last Updated: November 2024</p>
              ...
              <div className="snapshot-details space-y-4">
                ...
                <div>
                  <h3 style={{ fontWeight: 700, marginBottom: '0.5rem' }}>Your Rights</h3>
                  <p>
                    You can request to see, change, or delete any data we have about you. Just email us at hello@softwitch.com.
                  </p>
                </div>

                <div>
                  <h3 style={{ fontWeight: 700, marginBottom: '0.5rem' }}>Kids</h3>
                  <p>
                    SoftWitch isn't designed for kids under 13. If you're a parent and think your kid used our site, let us know and we'll delete their data.
                  </p>
                </div>
                ...
                <p style={{ marginTop: '1rem', fontStyle: 'italic' }}>
                  Questions? Email hello@softwitch.com — we're real humans who actually respond.
                </p>
              </div>
            ...
            <div className="snapshot-content space-y-4">
              ...
              <div className="snapshot-details space-y-4">
                ...
                <div>
                  ...
                  <p>
                    Questions, concerns, or just want to say hi? Email us at hello@softwitch.com.
                  </p>
                </div>

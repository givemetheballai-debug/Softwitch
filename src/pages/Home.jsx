  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12 space-y-16">
      ...
      >
        ...
        <p className="text-lg text-sw-purple/80 max-w-2xl mx-auto">
      ...
      <motion.div
        ...
        className="bg-gradient-to-br from-sw-purple/5 to-sw-pink/5 rounded-xl p-8 text-center shadow-soft"
      >
        <h2 className="font-serif text-2xl text-sw-purple mb-4">
          🌘 Today's Cosmic Snapshot
        </h2>
        <p className="text-lg font-medium text-sw-purple mb-2">
          {dateStr}
        </p>
        ...
        <Link 
          to="/lore/moon-phases"
          className="inline-block mt-4 text-sm text-sw-pink hover:text-sw-purple transition-colors font-medium"
        >
          More on moon phases →
        </Link>
      </motion.div>
      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <a 
            ...
            className="bg-white rounded-xl p-8 hover:shadow-glow-pink transition-all duration-300 shadow-soft"
          >
            <h3 className="font-serif text-2xl text-sw-pink mb-3">
              Big Scream Energy
            </h3>
      ...
      >
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-gradient-to-br from-sw-yellow/10 to-sw-pink/10 rounded-xl p-6 shadow-soft">
          ...
          <div className="bg-gradient-to-br from-sw-teal/10 to-sw-purple/10 rounded-xl p-6 shadow-soft">
            <h3 className="font-serif text-xl text-sw-purple mb-3">
          ...
          <div className="bg-gradient-to-br from-sw-pink/10 to-sw-purple/10 rounded-xl p-6 shadow-soft">
            <h3 className="font-serif text-xl text-sw-purple mb-3">
              A grounding moment
            </h3>
            <p className="text-sm text-sw-purple/80">
      ...
      <motion.div
        ...
        className="bg-gradient-to-br from-sw-rust/10 to-sw-yellow/10 rounded-xl p-8 shadow-soft"
      >

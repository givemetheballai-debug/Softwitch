    ...
    <div className="max-w-7xl mx-auto px-6 py-12 space-y-16">
      ...
      >
        <div className="relative z-10 bg-white/90 backdrop-blur-sm rounded-lg p-6">
          ...
          <Link 
            to="/lore/moon-phases"
            className="inline-block text-base text-sw-pink hover:text-sw-purple transition-colors font-semibold"
          >
            More on moon phases ✨
          </Link>
        </div>
      ...
      >
        <h2 className="font-serif text-2xl text-sw-purple sparkle-hover">

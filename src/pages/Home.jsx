      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <Link 
            ...
            className="product-card bg-white rounded-xl p-8 hover:shadow-glow-purple transition-all duration-300"
          >
            <h3 className="font-serif text-2xl mb-3 font-semibold link-rust">
              Rituals
            </h3>
            <p className="text-base text-sw-purple/80">
          ...
          <Link 
            ...
            className="product-card bg-white rounded-xl p-8 hover:shadow-glow-purple transition-all duration-300"
          >
            <h3 className="font-serif text-2xl mb-3 font-semibold link-pink">
              Inner Tools
            </h3>
            <p className="text-base text-sw-purple/80">
          ...
          <Link 
            ...
            className="product-card bg-white rounded-xl p-8 hover:shadow-glow-purple transition-all duration-300"
          >
            <h3 className="font-serif text-2xl mb-3 font-semibold link-teal">
              Birth Chart
            </h3>
            <p className="text-base text-sw-purple/80">

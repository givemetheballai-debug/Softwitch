    ...
    <div className="max-w-7xl mx-auto px-6 py-12 space-y-16">
      ...
      >
        <div className="relative z-10 bg-white/90 backdrop-blur-sm rounded-lg p-4">
          <h2 className="font-serif text-xl text-sw-purple mb-1">
            🌘 Today's Cosmic Snapshot
          </h2>
          <p className="text-sm font-medium text-sw-purple mb-1">
            {dateStr}
          </p>
          <p className="text-xs text-sw-purple/80">
            Today's moon: {moonPhase.name} — {moonPhase.description}<br />
            Today's season: {season.name} — {season.description}
          </p>
          <Link 
            to="/lore/moon-phases"
            className="inline-block mt-2 text-xs text-sw-pink hover:text-sw-purple transition-colors font-medium"
          >
            More on moon phases ✨
          </Link>
        </div>

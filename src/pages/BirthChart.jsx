  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (birthData.location && birthData.time) {
        ...
        if (!location) {
          alert(`Couldn't find location "${birthData.location}". Try being more specific (e.g., "Bridgeport, Connecticut" or "Cincinnati, Ohio")`);
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <p style={{ fontSize: '0.75rem', marginTop: '0.5rem', color: '#000', opacity: 0.7 }}>
                  Be specific: "Bridgeport, Connecticut" or "Cincinnati, Ohio"
                </p>
              </div>
      ...
      {result && (
        ...
        >
          ...
          <div className="polka-box-y2k">
            ...
            <p style={{ marginTop: '10px', color: '#000', fontWeight: 600, background: 'rgba(255,255,255,0.9)', padding: '15px', borderRadius: '15px' }}>
              You're a {result.sun.name} — {result.sun.element} energy at your core. This is the energy you naturally radiate.
            </p>
          </div>
          ...
          <div className="magic-box-y2k">
            ...
            <p style={{ marginTop: '10px', color: 'white' }}>
              Your emotional world runs on {result.moon.name} — {result.moon.element} energy. This is how you process feelings and recharge.
            </p>
          </div>
          ...
          <div className="game-card">
            ...
            <p style={{ marginTop: '10px', color: '#000', fontWeight: 600, background: 'rgba(255,255,255,0.9)', padding: '15px', borderRadius: '15px' }}>
              You show up with {result.rising.name} energy — {result.rising.element} vibes. This is your first-impression aura.
            </p>
